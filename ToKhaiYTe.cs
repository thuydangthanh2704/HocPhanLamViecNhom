...
{
    public partial class ToKhaiYTe : Form
    {
        public ToKhaiYTe()
        {
            InitializeComponent();
        ...
        private void btnGuiToKhai_Click(object sender, EventArgs e)
        {
            string sql = "Insert into KhaiBao values (@CMND, @HoTen, @NamSinh, @GioiTinh, @QuocTich, @TinhVN, @HuyenVN, @XaVN, @DiaChiCuTheVN, @SDT, @Email, @DiChuyen, @TinhDiChuyen, @HuyenDiChuyen, @XaDiChuyen, @DiaChiCuTheDiChuyen, @DauHieuBenhLy, @TiepXucNguoiBenh, @TiepXucNguoiNuocCoCovid, @TiepXucNguoiCoBieuHien)";
        ...
        private void ToKhaiYTe_Load(object sender, EventArgs e)
        {
            txtHoTen.Text = HoTen;
            txtCMND.Text = CMND;
